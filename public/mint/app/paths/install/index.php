...
if (!isset($_POST['action']))
{
	...
	include_once('app/paths/install/eula.php');
}
else
{
	...
	switch($MintAction)
	{
		...
		case 'Accept':
			if (isset($_POST['accept']))
			{
				...
				include_once('app/paths/install/activation.php');
			}
			else
			{
		...
		case 'Activate':
			...
			{
				include_once('app/paths/install/configuration.php');
			}
			else
			{
				include_once('app/paths/errors/index.php');
		...
		case 'Configure':
			if ($Mint->install())
			{
				include_once('app/paths/install/instructions.php');
			}
			else
			{
				include_once('app/paths/errors/index.php');
